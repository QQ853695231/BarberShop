...
<script type="text/javascript">
		...
		$.getJSON("willbeedit"
                    ,function(responsetxt){
                            ...
                            $("#modifyposition").val(responsetxt.position);
                            $("#modifysex").val(responsetxt.sex);
                            $("#modifyaddress").val(responsetxt.address);
                            $("#modifytel").val(responsetxt.tel);
                            $("#modifysalary").val(responsetxt.salary);
                    });
...
<div class="inneradd">
        ...
        <div>
        <p>
         <span>密&nbsp;&nbsp;码：<input type="text" id="modifypassword"></span>
        </p>
        </div>
        <p>
